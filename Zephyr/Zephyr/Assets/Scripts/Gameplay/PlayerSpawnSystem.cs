...
public class PlayerSpawnSystem : MonoBehaviour
{
	...
	[SerializeField] private CameraFollowObject _playerFollow = default;
	[SerializeField] private TransformAnchor _playerTransformAnchor = default;
	[SerializeField] private TransformAnchor _playerFollowObjectTransformAnchor = default;
	[SerializeField] private TransformEventChannelSO _playerInstantiatedChannel = default;
	[SerializeField] private TransformEventChannelSO _playerFollowObjectInstantiatedChannel = default;
	...
	private void SpawnPlayer()
	{
		...
		_playerFollowObjectInstantiatedChannel.RaiseEvent(followObjectInstance.transform);
		_playerFollowObjectTransformAnchor.Provide(followObjectInstance.transform);
