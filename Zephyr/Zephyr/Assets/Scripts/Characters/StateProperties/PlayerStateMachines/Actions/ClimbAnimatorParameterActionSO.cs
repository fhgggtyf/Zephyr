...
public class ClimbAnimatorParameterActionSO : StateActionSO
{
    ...
    protected override StateAction CreateAction() => new ClimbAnimatorParameterAction(animName, playSpeed);
...
public class ClimbAnimatorParameterAction : StateAction
{
    ...
    public ClimbAnimatorParameterAction(string[] param, float playSpeedParam)
    {
        _animNames = param;
    ...
    {
        _animManager.ChangeAnimState(_animPlaying, _playSpeed);
    }
