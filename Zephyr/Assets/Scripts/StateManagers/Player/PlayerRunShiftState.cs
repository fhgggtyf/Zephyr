...
public class PlayerRunShiftState : PlayerBaseState
{
    public PlayerRunShiftState(PlayerStateManager currentContext, PlayerStateFactory playerStateFactory)
    ...
    public override void UpdateState()
    {
        ...
        _ctx.DesiredVelocity = new Vector2(_ctx.DirectionX, 0f) * Mathf.Max(_ctx.MaxRunShiftSpeed - _ctx.Ground.GetFriction(), 0f);
